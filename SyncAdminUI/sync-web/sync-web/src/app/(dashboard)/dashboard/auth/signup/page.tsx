...
export const metadata: Metadata = {
  title: "Next.js SignUp Page | SyncAdmin - Next.js Dashboard Template",
  description: "This is Next.js SignUp Page SyncAdmin Dashboard Template",
  // other metadata
};

...
export const metadata: Metadata = {
  title: "Next.js SignIn Page | SyncAdmin - Next.js Dashboard Template",
  description: "This is Next.js Signin Page SyncAdmin Dashboard Template",
};

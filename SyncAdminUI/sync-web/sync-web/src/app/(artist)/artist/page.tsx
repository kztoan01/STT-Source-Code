                ...
                <div className="relative">
                    <div className="pb-12 pt-16 sm:pb-4 lg:pt-12">
                        <div className="lg:px-8">
                            <div className="lg:max-w-4xl">
                                <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                    <h1 className="text-2xl font-bold leading-7 text-slate-900">Your Musics</h1>
                                </div>
                            </div>
                        </div>
                        <div className="divide-y divide-slate-100 sm:mt-4 lg:mt-8 lg:border-t lg:border-slate-100">
                            ...
                            {/* <article aria-labelledby="episode-4-title" className="py-10 sm:py-12">
                                <div className="lg:px-8">
                                    <div className="lg:max-w-4xl">
                                        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                            <div className="flex flex-col items-start">
                                                <h2 id="episode-4-title" className="mt-2 text-lg font-bold text-slate-900"><a
                                                    href="/4">4: Shooter McGavin</a></h2><time
                                                        dateTime="2022-02-17T00:00:00.000Z"
                                                        className="order-first font-mono text-sm leading-7 text-slate-500">February
                                                    17, 2022</time>
                                                <p className="mt-1 text-base leading-7 text-slate-700">When golf-obsessed
                             ...
                             <article aria-labelledby="episode-3-title" className="py-10 sm:py-12">
                                <div className="lg:px-8">
                                    <div className="lg:max-w-4xl">
                                        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                            <div className="flex flex-col items-start">
                                                <h2 id="episode-3-title" className="mt-2 text-lg font-bold text-slate-900"><a
                                                    href="/3">3: The Wet Bandits</a></h2><time
                                                        dateTime="2022-02-10T00:00:00.000Z"
                                                        className="order-first font-mono text-sm leading-7 text-slate-500">February
                                                    10, 2022</time>
                                                <p className="mt-1 text-base leading-7 text-slate-700">The Christmas of 1989
                            ...
                            <article aria-labelledby="episode-2-title" className="py-10 sm:py-12">
                                <div className="lg:px-8">
                                    <div className="lg:max-w-4xl">
                                        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                            <div className="flex flex-col items-start">
                                                <h2 id="episode-2-title" className="mt-2 text-lg font-bold text-slate-900"><a
                                                    href="/2">2: Hank Scorpio</a></h2><time
                                                        dateTime="2022-02-03T00:00:00.000Z"
                                                        className="order-first font-mono text-sm leading-7 text-slate-500">February
                                                    3, 2022</time>
                                                <p className="mt-1 text-base leading-7 text-slate-700">What looks to outsiders
                            ...
                            <article aria-labelledby="episode-1-title" className="py-10 sm:py-12 mb-20">
                                <div className="lg:px-8">
                                    <div className="lg:max-w-4xl">
                                        <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                            <div className="flex flex-col items-start">
                                                <h2 id="episode-1-title" className="mt-2 text-lg font-bold text-slate-900"><a
                                                    href="/1">1: Skeletor</a></h2><time
                                                        dateTime="2022-01-27T00:00:00.000Z"
                                                        className="order-first font-mono text-sm leading-7 text-slate-500">January
                                                    27, 2022</time>
                                                <p className="mt-1 text-base leading-7 text-slate-700">You know him as an evil
            ...
            <footer className="border-t border-slate-200 bg-slate-50 py-10 pb-40 sm:py-16 sm:pb-32 lg:hidden">
                <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4">
                    <section>
                        ...
                        <p className="mt-2 text-base leading-7 text-slate-700 lg:line-clamp-4">In this show, Eric and Wes dig
                    ...
                    <h2 className="mt-8 flex items-center font-mono text-sm font-medium leading-7 text-slate-900"><svg
                        aria-hidden="true" viewBox="0 0 11 12" className="h-3 w-auto fill-slate-300">
                        <path
                    ...
                    </svg><span className="ml-2.5">Hosted by</span></h2>
                    <div className="mt-2 flex gap-6 text-sm font-bold leading-7 text-slate-900">Eric Gordon<span
                        aria-hidden="true" className="text-slate-400">/</span>Wes Mantooth</div>
                </div>
            </footer>

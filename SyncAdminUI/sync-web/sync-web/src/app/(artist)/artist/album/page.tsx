...
const Album = () => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            setLoading(true);
            const response = await axiosInstance.post('/music-service/api/Album/createAlbum', formData);
                ...
                <div className="pb-12 pt-16 sm:pb-4 lg:pt-12">
                    <div className="lg:px-8">
                        <div className="lg:max-w-4xl">
                            <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                <h1 className="text-2xl font-bold leading-7 text-slate-900">Album</h1>
                            </div>
                        </div>
                    </div>
                    <div className="divide-y divide-slate-100 sm:mt-4 lg:mt-8 lg:border-t lg:border-slate-100">
                                    ...
                                    <div className="space-y-12 lg:grid lg:grid-cols-4 lg:gap-x-6 lg:space-y-0">
                                        {albums?.map((album) => (
                                            ...
                                            <div key={album.id} className="group relative pb-8">
                                                ...
                                                <p className="text-black text-gray-900">{album.albumDescription}</p>
                        ...
                        <div className="lg:px-8 mt-12">
                            <div className="lg:max-w-4xl">
                                <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                    <h1 className="text-2xl font-bold leading-7 text-slate-900 pt-6">Create new Album</h1>
                                </div>
                            </div>
                        </div>
                        <div className="divide-y divide-slate-100 sm:mt-4 lg:mt-8 lg:border-t lg:border-slate-100">
                                            ...
                                            <div className="p-7">
                                                ...
                                                <div className="mb-5.5">
                                                    ...
                                                    <input
                                                        ...
                                                        name="Caption"
                                                        id="Caption"
                                                        placeholder="Add a caption to your album"
                                                    />
                                                </div>
                                    ...
                                    <div className="col-span-5 xl:col-span-2">
                                        <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                                            ...
                                            <div className="p-7">
                                                ...
                                                <div
                                                    id="FileUpload"
                                                    className="relative mb-5.5 block w-full appearance-none rounded border bg-gray px-4 py-4 dark:bg-meta-4 sm:py-7.5"
                                                >
                                                    {preview ? (
                                                        <Image
                                                            src={preview}

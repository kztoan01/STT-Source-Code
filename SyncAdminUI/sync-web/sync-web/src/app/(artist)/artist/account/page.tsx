                    ...
                    <div className="lg:px-8">
                        <div className="lg:max-w-4xl">
                            <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
                                <h1 className="text-2xl font-bold leading-7 text-slate-900">Account</h1>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div className="p-7">
                                                ...
                                                <div className="w-full sm:w-1/2">
                                                    ...
                                                    <div className="relative">
                                                        ...
                                                        <input
                                                            ...
                                                            value={"Shéyaa Bin Abraham-Joseph"}
                                                        />
                                                    </div>
                                                </div>
                                            ...
                                            <div className="mb-5.5">
                                                ...
                                                <input
                                                    ...
                                                    value={"Grammy Award Winning multi platinum artist 21 Savage, one of the most sought after rappers of this generation"}
                                                />
                                            </div>

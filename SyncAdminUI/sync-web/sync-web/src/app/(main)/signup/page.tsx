...
function Signup() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            const res = await axios.post(
                "http://13.211.134.159:8080/music-service/api/Account/register",
                { username, email, password, isArtist : true },
            ...
            if (axios.isAxiosError(error)) {
                if (error.response && error.response.status === 401) {
                    alert("This email id already exsist");
                    return;
                }
            }
    ...
    return (
        ...
        <div className="rounded-sm shadow-default dark:border-strokedark dark:bg-boxdark pt-8 pb-16">
                ...
                <div className="hidden w-full xl:block xl:w-1/2">
                    <div className="px-26 py-17.5 text-center">
                        ...
                        <p className="2xl:px-20">
                            Become our artist by creating new account!
                        </p>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-white outline-none focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                    />
                            ...
                            <div className="mb-5">
                                <input
                                    type="submit"
                                    value="Sign In"
                                    className="w-full cursor-pointer rounded-lg border border-stroke bg-gray p-4 text-white transition hover:bg-opacity-90"
                                />
                            </div>

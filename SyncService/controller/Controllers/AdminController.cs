...
public class AdminController(IAdminService adminService) : ControllerBase
{
    ...
    public async Task<IActionResult> DeleteArtist(Guid id)
    {
        ...
        if (result) return Ok(new { message = "Artist deleted successfully." });
    ...
    public async Task<IActionResult> DeletePlaylist(Guid id)
    {
        ...
        if (result) return Ok(new { message = "Playlist deleted successfully." });
    ...
    public async Task<IActionResult> DeleteMusic(Guid id)
    {
        ...
        if (result) return Ok(new { message = "Music deleted successfully." });

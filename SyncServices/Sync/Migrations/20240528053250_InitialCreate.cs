        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlaylistDescription = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistFirstName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ArtistLastName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SongDate = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "Birthdate", "City", "CountryId", "Name", "Password", "Status", "Username" },
                values: new object[,]
                {
                    { new Guid("03cb2bff-a4e1-4892-8368-09a1093e04da"), "123 Main St", new DateTime(1990, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "New York", 2, "John Doe", "password", "inactive", "john_doe" },
                    { new Guid("db4fd963-6ac6-4234-893b-5a95137ab1fb"), "hell hell", new DateTime(2012, 6, 18, 10, 34, 9, 0, DateTimeKind.Unspecified), "hcm", 1, "Minh Beo", "1234", "active", "wiramin" }
                });
